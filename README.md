...
credentials, or tokens. Public-browse allows same-origin subresource XHR/fetch
and service-worker side effects, known-origin cross-origin beacon traffic, and
active exact-origin public form navigation. It blocks cross-origin XHR/fetch,
unknown methods or request classes, and idle top-level side effects.
