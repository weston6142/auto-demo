...
- `@auto-demo/project`: Auto Demo schema v1 project manifest types, strict validation with accumulated structured errors, capture-bundle import into the normalized project layout, and project load/save APIs.
